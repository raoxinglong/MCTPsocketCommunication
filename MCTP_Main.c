 ...
 ***/
static int
AddSocket (int Socket,unsigned char IsLoopBackSocket, unsigned char IsFixedSocket)
{
    int i;
...
static
int InitializeSocket(unsigned int* n)
{
    int x=0;
    *n=0;
    ClearSocketTable();
...
static 
void* MCTPLANReceiver(void* pArg)
{
...
static
int InitializeMCTPLANSockets(void)
{
